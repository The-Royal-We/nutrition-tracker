...
export const ApplicationUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nutritionTrackerApp.applicationUser.delete.question">
        <Translate contentKey="nutritionTrackerApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
