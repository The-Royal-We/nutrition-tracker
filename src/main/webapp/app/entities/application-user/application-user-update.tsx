  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nutritionTrackerApp.applicationUser.home.createOrEditLabel" data-cy="ApplicationUserCreateUpdateHeading">
            <Translate contentKey="nutritionTrackerApp.applicationUser.home.createOrEditLabel">Create or edit a ApplicationUser</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('nutritionTrackerApp.applicationUser.someData')}
                id="application-user-someData"
                name="someData"
                data-cy="someData"
                type="text"
              />
              <ValidatedField
                ...
                label={translate('nutritionTrackerApp.applicationUser.internalUser')}
                type="select"
              >
                <option value="" key="0" />
                {users
