  ...
  return (
    <div>
      <h2 id="application-user-heading" data-cy="ApplicationUserHeading">
        <Translate contentKey="nutritionTrackerApp.applicationUser.home.title">Application Users</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="nutritionTrackerApp.applicationUser.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/application-user/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="nutritionTrackerApp.applicationUser.home.createLabel">Create new Application User</Translate>
          </Link>
        </div>
      </h2>
        ...
        {applicationUserList && applicationUserList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="nutritionTrackerApp.applicationUser.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="nutritionTrackerApp.applicationUser.someData">Some Data</Translate>
                </th>
                <th>
                  <Translate contentKey="nutritionTrackerApp.applicationUser.internalUser">Internal User</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {applicationUserList.map((applicationUser, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{applicationUser.someData}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="nutritionTrackerApp.applicationUser.home.notFound">No Application Users found</Translate>
            </div>
          )
        )}
      </div>
