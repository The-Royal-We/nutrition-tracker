...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NUTRITIONALDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_NUTRITIONALDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NUTRITIONALDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NUTRITIONALDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NUTRITIONALDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NUTRITIONALDATA actions', async () => {
      const expectedActions = [
        {
