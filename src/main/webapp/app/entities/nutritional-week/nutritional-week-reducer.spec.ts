...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NUTRITIONALWEEK_LIST actions', async () => {
    ...
    it('dispatches FETCH_NUTRITIONALWEEK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NUTRITIONALWEEK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NUTRITIONALWEEK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NUTRITIONALWEEK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NUTRITIONALWEEK actions', async () => {
      const expectedActions = [
        {
