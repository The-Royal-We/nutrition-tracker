...
class ApplicationUserResourceIT {
    ...
    private static final String DEFAULT_SOME_DATA = "AAAAAAAAAA";
    private static final String UPDATED_SOME_DATA = "BBBBBBBBBB";
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().someData(DEFAULT_SOME_DATA);
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().someData(UPDATED_SOME_DATA);
        return applicationUser;
    }
    ...
    void createApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getSomeData()).isEqualTo(DEFAULT_SOME_DATA);
    }
    ...
    void getAllApplicationUsers() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.[*].someData").value(hasItem(DEFAULT_SOME_DATA)));
    }
    ...
    void getApplicationUser() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.someData").value(DEFAULT_SOME_DATA));
    }
    ...
    void putExistingApplicationUser() throws Exception {
        ...
        updatedApplicationUser.someData(UPDATED_SOME_DATA);
        ...
        ApplicationUser testApplicationUser = applicationUserList.get(applicationUserList.size() - 1);
        assertThat(testApplicationUser.getSomeData()).isEqualTo(UPDATED_SOME_DATA);
    }
    ...
    void fullUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.someData(UPDATED_SOME_DATA);
